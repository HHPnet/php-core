...
use HHPnet\Core\Application\Services\Albums\GetAlbum\GetAlbumRequest;
...
class GetAlbumServiceSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('HHPnet\Core\Application\Services\Albums\GetAlbum\GetAlbumService');
    }
    ...
    public function it_is_possible_to_get_an_existing_album(GetAlbumRequest $request, Album $album)
    {
        ...
        $this->execute($request)->shouldHaveType('HHPnet\Core\Application\Services\Albums\GetAlbum\GetAlbumResponse');
    }
