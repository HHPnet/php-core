...
use HHPnet\Core\Application\Services\Songs\GetSong\GetSongRequest;
...
class GetSongServiceSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('HHPnet\Core\Application\Services\Songs\GetSong\GetSongService');
    }
    ...
    public function it_is_possible_to_get_an_existing_song(GetSongRequest $request, Song $song)
    {
        ...
        $this->execute($request)->shouldHaveType('HHPnet\Core\Application\Services\Songs\GetSong\GetSongResponse');
    }
