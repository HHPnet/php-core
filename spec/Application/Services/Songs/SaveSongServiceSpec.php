...
use HHPnet\Core\Application\Services\Songs\SaveSongRequest;
...
class SaveSongServiceSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('HHPnet\Core\Application\Services\Songs\SaveSongService');
    }
    ...
    public function it_is_possible_to_save_a_new_song(SaveSongRequest $request, Song $song, AlbumId $album_id)
    {
        ...
        $this->execute($request)->shouldHaveType('HHPnet\Core\Application\Services\Songs\SaveSongResponse');
    }
