...
use HHPnet\Core\Application\Services\Videos\SaveVideo\SaveVideoRequest;
...
class SaveVideoServiceSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('HHPnet\Core\Application\Services\Videos\SaveVideo\SaveVideoService');
    }
    ...
    public function it_is_possible_to_save_a_new_video(SaveVideoRequest $request, Video $video)
    {
        ...
        $this->execute($request)->shouldHaveType('HHPnet\Core\Application\Services\Videos\SaveVideo\SaveVideoResponse');
    }
